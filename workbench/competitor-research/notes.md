...
- Decision: Do not position the product only as an `AI book`. Position it as a trustworthy personalised children's book with photo-based hero creation, digital-first access, preview, and optional human quality control before print.
...
- Open question: Should v1 offer a full preview before payment, or a partial preview plus human confirmation?
- Open question: Should the first paid version be only digital PDF, or digital plus manual print fulfilment in Ukraine?
- Open question: How strongly should the landing page mention AI before quality and privacy are proven?
